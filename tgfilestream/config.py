...
start_message = os.environ.get("TG_START_MESG", "Envíe una imagen o archivo para obtener un enlace para descargarlo")
group_chat_message = os.environ.get("TG_G_C_MESG", "Lo siento. Pero solo trabajo en privado.")
